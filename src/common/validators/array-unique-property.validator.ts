...
@ValidatorConstraint({ name: 'ArrayObjUniquePropertyValidator' })
export class ArrayObjUniquePropertyValidator
  implements ValidatorConstraintInterface
{
  validate(
    ...
    if (typeof data !== 'object')
      throw new Error('ArrayObjUniquePropertyValidator must be used on array');
