...
export class updateData1685293777829 implements MigrationInterface {
    name = 'updateData1685293777829'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE "service_pack" DROP CONSTRAINT "REL_add1045f9e94234a314d6708b6"`);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE "service_pack" ADD CONSTRAINT "REL_add1045f9e94234a314d6708b6" UNIQUE ("user_id")`);
